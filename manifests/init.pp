...
class misp (
  ...
  $new_user_text = "Dear new MISP user,\\n\\nWe would hereby like to welcome you to the ${org} MISP community.\\n\\n Use the credentials below to log into MISP, where you will be prompted to manually change your password to something of your own choice.\\n\\nUsername: ${username}\\nPassword: ${password}\\n\\nIf you have any questions, don\'t hesitate to contact us at: ${contact}.\\n\\nBest regards,\\nYour ${org} MISP support team",
  $password_reset_text = "Dear MISP user,\\n\\nA password reset has been triggered for your account. Use the below provided temporary password to log into MISP at, where you will be prompted to manually change your password to something of your own choice.\\n\\nUsername: ${username}\\nYour temporary password: ${password}\\n\\nIf you have any questions, don\'t hesitate to contact us at: ${contact}.\\n\\nBest regards,\\nYour ${org} MISP support team",
